...
var possible = function (data, selected, roll) {
  ...
  if (roll == 0) {
    if (Math.floor(selected / 3) == 0) { return false }
  }
  if (roll == 1) {
    if (Math.floor(selected / 3) == 2) { return false; }
  }
  if (roll == 2) {
    if (selected % 3 == 0) { return false; }
  }
  if (roll == 3) {
    if (selected % 3 == 2) { return false; }
  }
  return true;
}
